...
//public class InvertedSeventhChordAuralPuzzle_State : State
//{
//    protected override void PrepareState(System.Action callback)
//    {
//        inversion = (Inversion)Random.Range(0, 3);

//        SeventhChord Chord = Enumeration.All<SeventhChordEnum>()[Random.Range(0, Enumeration.Length<SeventhChordEnum>())];
...
//        Tenor = (int)(inversion switch
//        {
//            Inversion.First => Fifth,
//            Inversion.Second => Seventh,
//            _ => Root
//        }).GetKeyboardNoteName() + Tenor < Bass ? Tenor + 12 : 0;

//        Alto = (int)(inversion switch
//        {
//            Inversion.First => Seventh,
//            Inversion.Second => Root,
//            _ => Third
//        }).GetKeyboardNoteName() + Alto < Bass ? Alto + 12 : 0;

//        Soprano = (int)(inversion switch
//        {
//            Inversion.First => Root,
//            Inversion.Second => Third,
//            _ => Fifth
//        }).GetKeyboardNoteName() + Soprano < Bass ? Soprano + 12 : 0;
...
//    {
//        var bass = AudioParser.GetAudioClipFromKey(Bass);
//        var tenor = AudioParser.GetAudioClipFromKey(Tenor);
//        var alto = AudioParser.GetAudioClipFromKey(Alto);
//        var soprano = AudioParser.GetAudioClipFromKey(Soprano);

//        AudioManager.Io.KBAudio.PlaySeventhChord(bass, tenor, alto, soprano);
//    }
...
//                SetStateDirectly(new InvertedSeventhChordAuralPuzzle_State());
//            }
//            else
//            {
...
//                AudioClip bass = AudioParser.GetAudioClipFromKey(Keyboard.SelectedKeys[0].KeyboardNoteName);
//                AudioClip tenor = AudioParser.GetAudioClipFromKey(Keyboard.SelectedKeys[1].KeyboardNoteName);
//                AudioClip alto = AudioParser.GetAudioClipFromKey(Keyboard.SelectedKeys[2].KeyboardNoteName);
//                AudioClip soprano = AudioParser.GetAudioClipFromKey(Keyboard.SelectedKeys[3].KeyboardNoteName);
...
//        .SetTextString("Find the <b><i>inverted seventh chord")
